                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alamat" placeholder="Contoh: rt 1 rw 10 jogodipan, requiredDusun II, Gemblegan, Kec. Kalikotes, Kabupaten Klaten, Jawa Tengah"
                ...
                <table class="table col-7">
                    ...
                    @foreach ($anggotas as $anggota)
                        <tr class="text-center">
                            ...
                            <td> <a class="text-decoration-none" href="/simpanan-wajib/detail/{{ $anggota->id }}"> @format($anggota->simpanan_wajib) </a> </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><button type="button" class="dropdown-item disable" @if (intval($anggota->simpanan_pokok) !== 0 ) @disabled(true) @endif data-bs-toggle="modal"
