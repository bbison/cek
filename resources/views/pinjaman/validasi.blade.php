                            ...
                            <td>
                                @if ($p->status_pinjaman == 'Selesai')
                                    <button class="btn btn-white" type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="text-success" width="20" height="20"
                                ...
                                @elseif($p->status_pinjaman == 'Ditolak')
                                    <button class="btn btn-white" type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="text-danger" width="20" height="20" fill="currentColor" class="bi bi-x-square-fill" viewBox="0 0 16 16">
